...
public class UserResponseDto {
  ...
  @Schema(name = "id", description = "Name for user creation", example = "Brayan")
  private String name;
  ...
  @Schema(name = "created", description = "Creation date of user", example = "2023-12-12T22:23:46.24338")
  private LocalDateTime created;

  @Schema(name = "created", description = "Modification date of user", example = "2023-12-12T22:23:46.24338")
